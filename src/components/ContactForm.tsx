    ...
    <section className="section-padding bg-white" aria-labelledby="contact-heading">
      <div className="container-custom">
        <div className="mx-auto max-w-2xl text-center">
          <h2 id="contact-heading" className="heading-2 text-gray-900">
            {title}
          </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6" noValidate>
            <div>
              ...
              <input
                ...
                className="mt-2 block w-full rounded-lg border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm px-4 py-3 border"
                aria-required="true"

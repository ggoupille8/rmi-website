...
const clients: Client[] = [
  ...
  { name: "Apple", logo: "https://cdn.simpleicons.org/apple/white", cdn: true, mobileSize: "h-[72px] lg:h-[84px] w-auto max-w-[90px] lg:max-w-[105px]" },
  ...
  { name: "Stellantis", logo: "/images/clients/stellantis.svg", cdn: false, mobileSize: "h-[52px] lg:h-[62px] w-auto max-w-[195px] lg:max-w-[221px] brightness-0 invert" },
  ...
  { name: "Target", logo: "/images/clients/target.svg", cdn: false, mobileSize: "h-8 lg:h-12 w-auto max-w-[120px] lg:max-w-[170px] brightness-0 invert" },

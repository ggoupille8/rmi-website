          ...
          {services.map((service, index) => {
            ...
            return (
              <button
                ...
                className={`flex items-center justify-center sm:justify-start gap-4 p-4 bg-neutral-900/50 backdrop-blur-sm border border-neutral-700/50 border-l-[3px] border-l-accent-500 hover:border-l-accent-400 hover:bg-neutral-800/60 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-accent-500/10 transition-all duration-200 text-left cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-500 focus-visible:ring-inset${isLastOdd ? " sm:col-span-2 lg:col-span-1" : ""}`}
              >
                <IconComponent

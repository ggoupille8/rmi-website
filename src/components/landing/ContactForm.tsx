          ...
          <form onSubmit={handleSubmit} className="space-y-6" noValidate>
            <div>
              ...
              <input
                ...
                className="mt-2 block w-full rounded-md border-neutral-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm px-4 py-3 border bg-white text-neutral-900"
                aria-required="true"
            ...
            <div>
              <label htmlFor="projectType" className="block text-sm font-medium text-neutral-800">
                Project Type
              </label>
              <select
                id="projectType"
